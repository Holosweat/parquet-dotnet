...
namespace Parquet.Extensions
{
    ...
    static class UntypedArrayExtensions
    {
        ...
        public static void PackNullsFast(
            this Array array,
            int offset,
            int count,
            Array packedData,
        ...
        private static void PackNullsTypeFast(
            bool?[] array,
            int offset,
            int count,
            bool[] packedArray,
        ...
        public static void UnpackNullsFast(
            this Array array,
            Span<int> flags,
            int fillFlag,
            Array result
        )
        {
            ...
            if (t == typeof(bool))
            {
                UnpackNullsTypeFast((bool[])array, flags, fillFlag, (bool?[])result);
                return;
            }
            if (t == typeof(byte))
            {
                UnpackNullsTypeFast((byte[])array, flags, fillFlag, (byte?[])result);
                return;
            }
            if (t == typeof(sbyte))
            {
                UnpackNullsTypeFast((sbyte[])array, flags, fillFlag, (sbyte?[])result);
                return;
            }
            if (t == typeof(short))
            {
                UnpackNullsTypeFast((short[])array, flags, fillFlag, (short?[])result);
                return;
            }
            if (t == typeof(ushort))
            {
                UnpackNullsTypeFast((ushort[])array, flags, fillFlag, (ushort?[])result);
                return;
            }
            if (t == typeof(int))
            {
                UnpackNullsTypeFast((int[])array, flags, fillFlag, (int?[])result);
                return;
            }
            if (t == typeof(uint))
            {
                UnpackNullsTypeFast((uint[])array, flags, fillFlag, (uint?[])result);
                return;
            }
            if (t == typeof(long))
            {
                UnpackNullsTypeFast((long[])array, flags, fillFlag, (long?[])result);
                return;
            }
            if (t == typeof(ulong))
            {
                UnpackNullsTypeFast((ulong[])array, flags, fillFlag, (ulong?[])result);
                return;
            }
            if (t == typeof(BigInteger))
            {
                UnpackNullsTypeFast((BigInteger[])array, flags, fillFlag, (BigInteger?[])result);
                return;
            }
            if (t == typeof(float))
            {
                UnpackNullsTypeFast((float[])array, flags, fillFlag, (float?[])result);
                return;
            }
            if (t == typeof(double))
            {
                UnpackNullsTypeFast((double[])array, flags, fillFlag, (double?[])result);
                return;
            }
            if (t == typeof(decimal))
            {
                UnpackNullsTypeFast((decimal[])array, flags, fillFlag, (decimal?[])result);
                return;
            }
            if (t == typeof(DateTime))
            {
                UnpackNullsTypeFast((DateTime[])array, flags, fillFlag, (DateTime?[])result);
                return;
            }
            if (t == typeof(TimeSpan))
            {
                UnpackNullsTypeFast((TimeSpan[])array, flags, fillFlag, (TimeSpan?[])result);
                return;
            }
            if (t == typeof(Interval))
            {
                UnpackNullsTypeFast((Interval[])array, flags, fillFlag, (Interval?[])result);
                return;
            }
            if (t == typeof(string))
            {
                UnpackNullsTypeFast((string[])array, flags, fillFlag, (string[])result);
                return;
            }
            if (t == typeof(byte[]))
            {
        ...
        private static void UnpackNullsTypeFast(
            bool[] array,
            Span<int> flags,
            int fillFlag,
            bool?[] result
        ...
        public static void ExplodeFast(
